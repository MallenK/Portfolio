...
const Services: React.FC<Props> = ({ content }) => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      // Uso de fromTo con autoAlpha para asegurar que los elementos sean visibles
      gsap.fromTo(".service-card", 
        ...
        },
        {
          y: 0,
          autoAlpha: 1,
          stagger: 0.1, // Stagger ajustado para fluidez
          duration: 0.8,
          ease: "power3.out",
          scrollTrigger: {
    ...
    <section ref={containerRef} className="py-32 px-6 bg-[#0B0B0B]">
      <div className="max-w-7xl mx-auto">
        <div className="mb-24">
          ...
          <h3 className="text-6xl md:text-8xl font-black uppercase tracking-tighter">{content.title}</h3>
        </div>
